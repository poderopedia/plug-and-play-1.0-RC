...
settings.email_server = 'mail.poderopedia.com'
settings.email_sender = 'dev@poderopedia.com'
settings.login_config = 'poderopedia:594f1fcf7f1981b293d3e6a704180310da42a0e6'
settings.plugins = []
TEXT_EDITOR = 'amy'
VERIFIY_EMAIL = """
<html><body>Hola
